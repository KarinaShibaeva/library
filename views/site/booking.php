...
<div class="d-flex justify-content-center mt-4 mb-3">
    <div class="card w-75 mt-5 align-items-center shadow p-3 mb-5 rounded" style="background-color: #eee4e4;">
        <div class="card-body w-100">
            ...
            <div class="d-flex justify-content-between">
                <div class="w-100 me-2"><?= $form->field($model, 'book_name')->textInput(['autofocus' => true]) ?></div>
                <div class="w-100 me-2"><?= $form->field($model, 'book_author')->textInput(['autofocus' => true]) ?></div>
            ...
            <?php ActiveForm::end(); ?>
            <p>Для получения книги, в случае одобрения заявки, необходимо посетить библиотеку лично</p>
        </div>
    </div>
</div>
